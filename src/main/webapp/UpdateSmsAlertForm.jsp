...
<title>Application Loan SMS Form</title>
                            ...
                            <div class="innercard-md">
                                ...
                                <div class="form-normal">
                                    ...
                                    <div class="fgroup">
                                        ...
                                        <input type="datetime-local" class="forminput" placeholder="Date Loaned" />
                                    </div>
                                   
                                    <div class="fgroup">
                                        <label>Send To</label>
                                        <input type="text" class="forminput" placeholder="Send To" />
                                    </div>
                                    
                                    <div class="fgroup">
                                        <label>Message</label>
                                        <textarea class="forminput" rows="6"></textarea>
                                ...
                                <div class="rowBtn">
                                    ...
                                    <button class="btnInfo">SEND</button>
