...
<title>UpdateNormalStaffAccount</title>
<style>
     html, body{
...
<section class="topnav">
	...
	<div class="loan-request-form-container">
        <form action="" method="post" style= "padding:50px 50px 50px 50px; text-align:auto;">
		<div class= "">
		...
		<input type="text" name="" id= "col-span-75" value=""/><br>
